          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <RouterLink class="px-3 py-2 rounded-md text-sm font-medium  text-gray-300 hover:bg-gray-700 hover:text-white" activeClass="px-3 py-2 rounded-md text-sm font-medium  bg-gray-900 text-white" to="/">Care</RouterLink>
                <RouterLink class="px-3 py-2 rounded-md text-sm font-medium  text-gray-300 hover:bg-gray-700 hover:text-white" activeClass="px-3 py-2 rounded-md text-sm font-medium bg-gray-900 text-white" to="/sales">Sales</RouterLink>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
